...
const Login = () => {
    ...
    const handleLogin = async (e) =>{
        ...
        try {
            const respone = await axios.post("http://localhost:8080/login",{email,password})
                        ...
                        <div id="form-login" className='xl:basis-1/3 lg:basis-1/2 sm:basis-2/3 max-sm:w-full'>
                            ...
                            <form className="md:mt-10 mt-6">
                                <div className="email ">
                                    ...
                                    <input className="border-line px-4 pt-3 pb-3 w-full rounded-lg mt-2" id="username" type="email" placeholder="" required value={email} onChange={e => setEmail(e.target.value)}/>
                                </div>
                                <div className="pass mt-5">
                                    <label htmlFor="password" className='text-variant1'>Password<span className='text-primary'>*</span></label>
                                    <input className="border-line px-4 pt-3 pb-3 w-full rounded-lg mt-2" id="password" type="password" value={password} placeholder="" required onChange={e => setPassword(e.target.value)}/>
                                </div>
                                ...
                                <div className="block-button mt-6">
                                    <button className="button-main w-full text-center" type = "button" onClick={handleLogin}>Login</button>
                                </div>
                            </form>
